...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    // The backend uses 'username' but the form uses 'email'. 
    // In this app, email is often used as the username.
    const success = await login(email, password)
    if (success) {
      addToast('Login successful', 'success', 'Welcome back!')
      navigate('/dashboard')
    } else {
  ...
  return (
    <>
      ...
      <div id="content" className="login-page" style={{ display: isLoading ? 'none' : 'block' }}>
